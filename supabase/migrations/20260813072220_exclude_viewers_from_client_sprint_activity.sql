-- Viewer accounts can be assigned to a project for read-only client access,
-- but they do not contribute sprint activity and must not appear in the
-- project-member activity table.
